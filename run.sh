...
#
python evasion_attacks.py --dataset gtsrb --model-name gtsrb_clean.h5
python evasion_attacks.py --dataset gtsrb --model-name gtsrb_clean.h5 --target-label 33
python evasion_attacks.py --dataset gtsrb --model-name gtsrb_clean.h5 --target-label 0
#
