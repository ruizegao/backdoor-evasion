...
MODEL_FILEPATH = '../models/gtsrb_bottom_right_white_4_target_22.h5'  # model file
# LOAD_TRAIN_MODEL = 0
NUM_CLASSES = 43
PER_LABEL_RARIO = 0.1
...
def load_dataset(data_file=('%s/%s' % (DATA_DIR, DATA_FILE))):
    ...
    X_train = np.array(dataset['X_test'], dtype='float32')
    Y_train = np.array(dataset['Y_test'], dtype='float32')
